...
function App() {
  ...
  const tipos = [
    ...
    "Choque contra 3ro. en movimiento",
  ...
  return (
    <section className="section-all">
      ...
      <Button
        ...
        onClick={() => {
          validacionTexto();
          !visibleCard ? handleWhatsAppLink("+51987400228") : {};
        }}
      ...
      {validacion && (
        <>
        <Card className="dark message">
      <CardHeader  className="header-msg">
        Alerta
      </CardHeader>
      <CardBody >
        <p style={{marginBottom:'1rem'}}>Debe completar todos los campos.</p>
        <Button onClick={()=>{setValidacion(false)}} color="primary">
      Aceptar
    </Button>
      </CardBody>
    </Card>
